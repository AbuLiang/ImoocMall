                            ...
                            <li v-for="(item,index) in cartList" :key="index" v-show="item.checked=='1'">
                                <div class="cart-tab-1">
                                    <div class="cart-item-pic">
                                        <img v-lazy="'/image/'+item.productImage" :alt="item.productName">
                                    </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            payMent () {
                var addressId = this.$route.query.addressId // 从全局路由对象中获取addressId;  
                // this.$route.query获取参数 this.$router.push 跳转页面  一个route一个router 
