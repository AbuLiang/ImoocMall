<template>
    <div>
                ...
                <div class="checkout-addr">
                    ...
                    <div class="addr-list-wrap">
                        ...
                        <div class="shipping-addr-more">
                            <a class="addr-more-btn up-down-btn" href="javascript:;" @click="expand" v-bind:class="{'open':limit>2}">
                                more
                                <i class="i-up-down">
        ...
        <modal :modalShow="isModalShow" close="closeModal">
            <p slot="message">
                confirm delete ?
            </p>
            <div slot="btnGroup">
                <a class="btn btn--m" href="javascript:;" @click="delAddress()">确认</a>
                <a class="btn btn--m" href="javascript:;" @click="isModalShow=false">取消</a>
            </div>
        </modal>
